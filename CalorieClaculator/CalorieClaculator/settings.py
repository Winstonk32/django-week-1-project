"""
Django settings for CalorieClaculator project.
...
SECRET_KEY = 'django-insecure-mh$$0gliquj50ytp_5if40q%!_7rhwzfq_zl+u3%w=+fu+vn7^'
...
WSGI_APPLICATION = 'CalorieClaculator.wsgi.application'
